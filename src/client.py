...
class MealieClient:
    ...
    def list_recipe_actions(
        ...
        Args:
            ...
            per_page: Number of actions per page
            order_by: Field to order by
            order_direction: "asc" or "desc"

        Returns:
            Paginated recipe actions data
        """
        params = {"page": page, "perPage": per_page}
        if order_by:
    ...
    def update_recipe_action(
        ...
        Returns:
            Updated recipe action data
        """
        # First get the existing action
        existing = self.get_recipe_action(item_id)

        # Build payload with updates
        payload = {
            "actionType": action_type if action_type is not None else existing["actionType"],
    ...
    def delete_recipe_action(self, item_id: str) -> None:
        ...
        Args:
            item_id: Recipe action UUID
        """
        return self.delete(f"/api/households/recipe-actions/{item_id}")
    ...
    def trigger_recipe_action(self, item_id: str, recipe_slug: str) -> Dict[str, Any]:
        ...
        """
        return self.post(f"/api/households/recipe-actions/{item_id}/trigger/{recipe_slug}", json={})
